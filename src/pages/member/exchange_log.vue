<template>
  <div class="app">
    <my-header @on-click-back="routeBack" :left-options="{preventGoBack: true}" :Title="'兑换记录'"></my-header>
    <div class="main2">
      <div class="content">
        <div class="dhlist">
          <div class="empty">
            <p class="pic"><img src="./images/empty.png"></p>
            <p class="tips">暂无兑换记录~</p>
          </div>
          <ul>
            <li>
              <div class="splist">
                ...
                <div class="right">
                  ...
                  <div class="info">
                    <span class="a1">298积分</span>
                    <span class="a2">已兑换</span>
                  </div>
                </div>
              </div>
            </li>
...
export default {
  ...
  methods: {
    routeBack () {
      this.$router.push({path: '/member/exchange'})
    }}
}
</script>
