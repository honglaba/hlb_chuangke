<template>
  <div class="app">
    <x-header title="个人信息" :left-options="{backText: '', preventGoBack: true}" @on-click-back="routeBack"></x-header>
    <div class="main2">
      <div class="content">
        <div class="myinfo">
          <div class="box1">
          ...
          <div class="box2">
            <group>
              ...
              <datetime title="生日" v-model="DataTree.birthday" placeholder="请选择"></datetime>
