  ...
  <div>
      ...
      <div class="swiper-container nav-swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <router-link to="/home/food" v-for="(item,index) in channel">
    ...
    <section class="vux-1px-tb bmar20 bgf tpad36" key="2">
      ...
      <div class="y-flex ad-type-one">
          <router-link tag="a" to="#" v-for="(item,index) in goods">
    ...
    <section class="vux-1px-tb bmar20 bgf tpad36" key="3">
      ...
      <div class="y-flex business">
        ...
        <router-link tag="a" to="#" class="flex1 sp" v-for="(item,index) in superme">
          <img :src='item.img_path'>
        </router-link>
      </div>
    </section>
